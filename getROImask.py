...
## load amygdala and hippocampus, 4 ROIs
...
# volume_brain_mask = view_data(tight_mask_full.shape, voxel_idx_brain, Lhippmask_flatten,
#                               save_to=roimask_dir + 'L_hippocampus')
# volume_brain_mask = view_data(tight_mask_full.shape, voxel_idx_brain, Lamymask_flatten,
#                               save_to=roimask_dir + 'L_amygdala')
# volume_brain_mask = view_data(tight_mask_full.shape, voxel_idx_brain, Rhippmask_flatten,
#                               save_to=roimask_dir + 'R_hippocampus')
# volume_brain_mask = view_data(tight_mask_full.shape, voxel_idx_brain, Ramymask_flatten,
#                               save_to=roimask_dir + 'R_amygdala')
