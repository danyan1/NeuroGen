...
def neurogen(model, classifier, maps, num_class, roi, num_steps=1000, lr=0.01, wdecay=0.0001, dims=(227, 227, 3),
             device=torch.device("cpu"), repeat_time=1, truncation=1):
